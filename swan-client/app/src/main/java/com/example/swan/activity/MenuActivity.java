...
public class MenuActivity extends AppCompatActivity {
    ...
    private View.OnClickListener myAccountListener=new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            ...
            if(AccountHelper.isLogin(MenuActivity.this)){
             ...
             QMUITipDialog tipDialog=   CommonUtil.getFailTipDialog(MenuActivity.this,"请先登录");
    ...
    private View.OnClickListener offlineMapListener=new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent intent=new Intent();
